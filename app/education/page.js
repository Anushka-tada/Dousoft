  ...
  return (
    <SolutionLayout
      hero={{
        title: "Education Solutions",
        description:
          "Innovative education solutions to enhance digital learning, streamline administration, and improve student engagement.",
        breadcrumb: "Home > Healthcare Solutions",
      }}
      ...
      intro={{
        ...
        imageClass: "Background-Shadow-3",
      }}
        ...
        cards: [
          {
            ...
            title: "Education-Focused Business Strategy",
            description:
              "Every education provider has unique learning models, audiences, and delivery methods. At Dousoft, we begin by understanding your educational goals—whether it’s student engagement, content delivery, assessment efficiency, or platform scalability.",
            subTitle: "Our approach ensures:",
            points: [
              {
                icon: "assets/images/healthcare/icon/material-symbols_automation.png",
                text: "Enhancing learning outcomes",
              },
              {
      ...
      framework={{
        heading: "Dousoft Education Delivery Framework",
        subheading:
          "We follow a structured framework to deliver consistent, high-quality Education solutions:",
        steps: [
          {
      ...
      offerings={{
        ...
        cards: [
          {
            overlayClass: "overlay-shadow edu-ind-5-picture-1",
            title: "Learning Management Systems (LMS)",
            description:
              "Custom LMS platforms for schools, universities, and training providers to manage courses, users, assessments, and certifications.",
          },
          {
            overlayClass: "overlay-shadow edu-ind-5-picture-2",
            title: "Online Learning & Virtual Classroom Platforms",
            description:
              "Interactive digital classrooms with live sessions, recorded content, quizzes, and collaborative tools to support remote and hybrid learning models.",
          },
          {
            overlayClass: "overlay-shadow edu-ind-5-picture-3",
            title: "Education Mobile App Development",
            description:
              "Mobile-first learning applications that provide anytime, anywhere access to educational content and assessments.",
          },
          {
            overlayClass: "overlay-shadow edu-ind-5-picture-4",
      ...
      benefits={{
        ...
        items: [
          { icon: "assets/images/healthcare/icon/Vector-3.png", text: "Enhanced student engagement and retention" },
          { icon: "assets/images/healthcare/icon/Vector-4.png", text: "Improved accessibility and flexibility" },
          { icon: "assets/images/healthcare/icon/Vector-5.png", text: "Reduced administrative overhead" },
          { icon: "assets/images/healthcare/icon/Vector-6.png", text: "Scalable and future-ready platforms" },
          { icon: "assets/images/healthcare/icon/Vector-7.png", text: "Data-driven academic insights" },
          { icon: "assets/images/healthcare/icon/Vector-8.png", text: "Secure Education Systems" },
        ],
      }}
      ...
      whyChoose={{
        ...
        imageClass: "overlay-shadow-2 edu-5-picture-5",
        points: [
          {
            icon: "assets/images/healthcare/icon/bxs_badge-check.png",
            text: "Deep understanding of education technology",
          },
          {
          ...
          },
          {
            ...
            text: "Secure and scalable architecture",
          },
          {
            icon: "assets/images/healthcare/icon/Vector (1).png",
            text: "Continuous support and optimization",
          },
        ],
        footerText:
          "We don’t just build e-learning platforms—we create digital learning ecosystems that support long-term educational growth and innovation.",
      ...
      cta={{
        heading: "Transform Learning Experiences with Dousoft",
        description:
          "Whether you are launching an edtech startup, modernizing an institution, or scaling a training platform, Dousoft delivers education solutions that combine technology, engagement, and efficiency to meet evolving learning needs.",
